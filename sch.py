                ...
                for i in data["analyzeResult"]["documentResults"]:
                    if (i["docType"] == "custom:form"):
                        ...
                        return org, cat, fn, mn, ln, d, ssn, email, tele, s,  c, st, sex, acc
                            #, mnam, asset, qty, tcnam, tcnam2, bnam1, badd1, bdob1, bnam2, badd2, bdob2, bnam3, badd3, bdob3, ahinam1, ahiadd1, ahinam2, ahiadd2, ahinam3,  ahiadd3, ahinam4, ahiadd4
